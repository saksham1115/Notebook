...
<div id="pagewrap">
	...
	<header id="header">
		...
		<hgroup>
			<div id=logo><a href="Homepage.html"><img src="./images/home_logo.png"></a></div>
...
-->
		...
		<form id="searchform" method=post action=searchit.php>
			<input type="search" name=searched id="s" placeholder="Search">
		</form></nav>
...
<h1 class="post-title" style="text-align: center;"><span style="font-family: 'Hanalei', cursive; font-size: xx-large; color: #003300; text-decoration: underline";><strong>
<?php 
$newsql = new mysqli("localhost", "root", "ishallcallhimsebastian", "notebook");
$res = $newsql->query("select name from users where id=$id")->fetch_assoc();
echo $res['name'];
?>
</strong></span></h1>
...
<h4 id=dash style="text-align: center; color: #000080; font-family: courier new,courier;font-size: x-small;"><span style="text-align: center; color: #000080; font-family: courier new,courier;font-size: x-medium;">Hello! </span><span id='uname' style="text-align: center; color: #000080; font-family: courier new,courier;font-size: x-medium;"><?php echo $_SESSION['name'] ?></span><br><br>Welcome back to your notebook!:)
<br>
